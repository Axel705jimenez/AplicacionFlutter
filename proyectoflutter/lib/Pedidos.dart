...
class _PedidosState extends State<Pedidos> {
  ...
  Future<void> fetchPedidos() async {
    final response = await http.get(Uri.parse('https://192.168.1.19:7019/api/Pedido'));
  ...
  Future<void> deletePedido(int id) async {
    final response = await http.put(Uri.parse('https://192.168.1.19:7019/api/Pedido/$id/CambiarEstatus'));
