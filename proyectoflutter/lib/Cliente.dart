...
class _ClientesState extends State<Clientes> {
  ...
  Future<void> fetchClientes() async {
    final response = await http.get(Uri.parse('https://192.168.1.19:7019/api/Cliente'));
  ...
  Future<void> deleteCliente(int id) async {
    final response = await http.put(Uri.parse('https://192.168.1.19:7019/api/Cliente/$id/CambiarEstatus'));
