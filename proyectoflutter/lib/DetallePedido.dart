...
class _DetallePedidoState extends State<DetallePedido> {
  ...
  Future<void> fetchDetallesPedidos() async {
    final response = await http.get(Uri.parse('https://192.168.1.19:7019/api/DetallePedido'));
  ...
  Future<void> deleteDetallePedido(int id) async {
    final response = await http.put(Uri.parse('https://192.168.1.19:7019/api/DetallePedido/$id/CambiarEstatus'));
