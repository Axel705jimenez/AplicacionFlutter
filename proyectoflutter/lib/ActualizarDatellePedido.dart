...
class _ActualizarDetallePedidoState extends State<ActualizarDetallePedido> {
  ...
  Future<void> actualizarDetallePedido() async {
    final response = await http.put(
      Uri.parse('https://192.168.1.19:7019/api/DetallePedido/${widget.detallePedido['idDetallePedido']}'),
          ...
          child: Column(
            children: [
              TextFormField(
                ...
                decoration: AppStyle.inputDecoratio(labelText: 'Nombre del producto'),
                validator: (value) {
              ...
              TextFormField(
                ...
                decoration: AppStyle.inputDecoratio(labelText: 'Cantidad'),
              ...
              TextFormField(
                ...
                decoration: AppStyle.inputDecoratio(labelText: 'Precio unitario'),
                keyboardType: TextInputType.number,
                validator: (value) {
                  if (value == null || value.isEmpty) {
